...
# Create the layout of the app using Bootstrap components
...
# Callback to enable/disable the select-year dropdown based on the selected statistics
@app.callback(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unmp_rec = recession_data.groupby('Vehicle_Type').agg({'unemployment_rate':'mean','Automobile_Sales':'mean'}).reset_index()
        R_chart4 = dcc.Graph(
            figure = px.bar(unmp_rec,
            x='Vehicle_Type',  
            y='Automobile_Sales',  
